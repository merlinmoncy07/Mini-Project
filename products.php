    ...
    <section class="section-products">
      <div class="container">
        <div class="list-products">
          <div class="product">
            <div class="top">
              <img src="https://www.netmeds.com/images/product-v1/600x600/886778/optiviral_eye_ointment_5gm_2_0.jpg" alt="product" class="img-product">
            </div>
            <div class="bottom">
              <h3 class="product-name"><a href="">Eye Ointments</a></h3>
            </div>
          </div>
          <div class="product">
            <div class="top">
              <img src="https://5.imimg.com/data5/ME/OQ/MY-4925890/lubiark-eye-drop-500x500.jpg" alt="product" class="img-product">
            </div>
            <div class="bottom">
              <h3 class="product-name"><a href="">Eye Drops</a></h3>
            </div>
          </div>
          <div class="product">
            <div class="top">
              <img src="https://5.imimg.com/data5/SELLER/Default/2021/5/ZX/FR/LM/57769294/vit-eye-tab-500x500.jpg" alt="product" class="img-product">

            </div>
            <div class="bottom">
              <h3 class="product-name"><a href="">Tablets</a></h3>
            </div>
          </div>
        </div>
      </div>
